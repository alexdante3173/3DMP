...
Inside the Spring Car folder you have every component of the car saved as an .stl file, the hole car saved as an .f3d file and the sliced components saved as
.gcode files.
